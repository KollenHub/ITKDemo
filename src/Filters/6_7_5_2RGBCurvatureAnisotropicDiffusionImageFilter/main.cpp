...
using FilterType = itk::VectorCurvatureAnisotropicDiffusionImageFilter<InputImageType, InputImageType>;
...
int main(int argc, char *argv[])
{
    ...
    reader->SetFileName("../../data/VisibleWomanHeadSlice.png");
    reader->Update();
    ...
    writer->SetFileName("../../output/RGBCurvatureAnisotropicDiffusionImageFilter.png");
